    ...
    function () {
      ...
      _createClass(Bone, [{
        ...
        value: function update() {
          ...
          var tResultMatrix;
          if (this.rotation = this.transform.skX, pMatrix) tResultMatrix = this.resultTransform.getMatrix(), Laya.Matrix.mul(tResultMatrix, pMatrix, this.resultMatrix),
           this.resultRotation = this.rotation; else if (this.resultRotation = this.rotation + this.parentBone.resultRotation, this.parentBone) {
