    ...
    public selectAllGameInfo(canUseNet = false) {
        return new Promise(async res => {
            if (canUseNet) {
                ...
                await this.selectSingleInfo(GameConst.TASK_INFO, false);
                await this.selectSingleInfo(GameConst.BOX_INFO, false);
                await this.selectSingleInfo(GameConst.OWN_PROP, false);
                await this.selectSingleInfo(GameConst.USE_PROP, false);
                await this.selectSingleInfo(GameConst.LEVEL_INFO, false);
                await this.selectSingleInfo(GameConst.FREE_DIAMOND, false);
            } else {
                ...
                await this.selectInfo(GameConst.TASK_INFO);
                await this.selectInfo(GameConst.BOX_INFO);
                await this.selectInfo(GameConst.OWN_PROP);
                await this.selectInfo(GameConst.USE_PROP);
                await this.selectInfo(GameConst.LEVEL_INFO);
                await this.selectInfo(GameConst.FREE_DIAMOND);
            }
            res();
        });
    }
