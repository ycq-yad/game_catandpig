...
export class DYMoreGameBanner extends BaseSceneUISkin {
    ...
    public constructor(data: { len: number, scrollCount: number }) {
        super();
        this.viewData_ = data;
        this.scrollCount = data.scrollCount;
        this.name = "DYMoreGameBanner";
        this.skin = "platform/dy/wechat/DYMoreGameBanner.json";
    }
    ...
    private initView() {
        ...
        let count = this.viewData_.len < len ? this.viewData_.len : len
    ...
    private onMove() {
        ...
        // console.log(this.box_view1.x, this.box_view2.x);
    }
