...
export class DYMoreGameDrawer extends BaseSceneUISkin {
    ...
    public constructor() {
        ...
        this.skin = "platform/dy/wechat/DYMoreGameDrawer.json";
    }
    ...
    public switchShow(show: boolean, time = 300) {
        ...
        if (this.isShow) {
            ...
            Laya.Tween.to(this.box_content, { left: 0 }, time, null, Laya.Handler.create(this, () => {
                this.initList();
            ...
            Laya.Tween.to(this.box_content, { left: -713 }, time, null, Laya.Handler.create(this, () => {
