...
/**
 * 嘟游渠道 更多游戏-抽屉游戏盒子Item
 */
export class DYMoreGameDrawerItem extends Laya.Box {
    public className_key = "DYMoreGameDrawerItem";
    ...
    private createUI() {
        ...
        this.img_db.skin = "resource/assets/platform/wechat/failed_baseboard_1.png";
